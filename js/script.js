...
if (hour > 5 && today.getHours() <= 7) {
    ...
    bgColor = 'linear-gradient(to right, #34a4ca 0%, #59d7dd 28%, #a8f2f0 59%, #d0f8ef 84%, #d6f6e1 100%)';
    ...
    bgColor = 'linear-gradient(135deg, #ffe3c8 0%, #efad9e 45%, #c79797 65%, #a78a92 85%, #857d8d 100%)';
    $(".sun").css("transform", 'rotate(-60deg) translate(40vw) rotate(-60deg)');
    $(".weather").css("left", '10%');
} else if (hour <= 17) {
    bgColor = 'linear-gradient(135deg, #536a97 11%, #8087ad 35%, #bca391 72%, #bd968a 96%, #a38b8a 100%)';
    $(".weather").css("left", '10%');
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        dataType: "json",
        data: {},
        url: "https://api.openweathermap.org/data/2.5/weather?id=your-id&appid=your-app-id&units=metric&lang=de",
